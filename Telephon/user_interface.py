    ...
    while True:
        ...
        if n == 1:
            ...
            if change == 1:
                ...
                lg.logging.info('Ошибка! Не корректные данные!')
                print(
